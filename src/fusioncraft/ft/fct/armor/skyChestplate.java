 ...
 */
public class skyChestplate extends ItemArmor{

	public skyChestplate(ArmorMaterial par1ArmorMaterial,
			int par2, int par3) {
		super(par1ArmorMaterial, par2, par3);
	}
	@Override
	public void registerIcons(IIconRegister iconRegister) {
		itemIcon = iconRegister.registerIcon("FusionCraft:SkyChestplate");
	}
